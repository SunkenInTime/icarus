...
def main():
    out=REV/'split-legacy105-lower-receiver-review-v5';out.mkdir(exist_ok=False)
    declaration=REV/'split-legacy105-connected-region-proposal-v5/combined-declarations.json'
