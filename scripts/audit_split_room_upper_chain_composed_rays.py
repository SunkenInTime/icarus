...
def main():
    out=REV/'split-room-upper-chain-standing-rays-v1';out.mkdir(exist_ok=False)
    fragment_path=REV/'split-room-upper-chain-combined-raw-v1/raw-source-fragments.npz';fr=np.load(fragment_path)
    ...
    for edge,axis,fixed,lo,hi,side in [(173,0,263.657,169.,195.9,1),(175,0,256.214,182.5,195.9,-1),
            ...
            (124,0,282.796,169.,210.2,-1),(172,1,168.451,263.9,298.5,1),(169,0,281.201,101.1,141.7,1),(170,1,141.87,281.4,298.5,-1),(171,0,298.744,142.1,168.3,1)]:
    ...
    report=dict(scope=__doc__,rawFragmentSha256=sha(fragment_path),sourcePartitionReportSha256=sha(fragment_path.parent/'partition-review.json'),
        ...
        scriptSha256=sha(Path(__file__)),declarationSha256=sha(REV/'split-vent-room-finite-field-experiment-v6/sealed-held-region-declaration.json'),upperChainDeclarationSha256=sha(REV/'split-upper-vent-chain-field-proposal-v1/held-region-declaration.json'),
