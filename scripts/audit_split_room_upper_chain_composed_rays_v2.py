...
def main():
    out=REV/'split-room-upper-chain-standing-rays-v2';out.mkdir(exist_ok=False)
    fragment_path=REV/'split-room-upper-chain-combined-raw-v2/raw-source-fragments.npz';fr=np.load(fragment_path)
    ...
    report=dict(scope=__doc__,rawFragmentSha256=sha(fragment_path),sourcePartitionReportSha256=sha(fragment_path.parent/'partition-review.json'),
        ...
        scriptSha256=sha(Path(__file__)),declarationSha256=sha(REV/'split-vent-room-finite-field-experiment-v6/sealed-held-region-declaration.json'),upperChainDeclarationSha256=sha(REV/'split-upper-vent-chain-field-proposal-v2/held-region-declaration.json'),
