...
class _AgentDragableState extends ConsumerState<AgentDragable>
  ...
  Widget build(BuildContext context) {
    ...
    final activeAbilityBarAgent = ref.watch(abilityBarProvider);
    ...
    final shouldDimForLineup = isLineupContext &&
        ...
        !isActiveLineupAgent;
    final shouldDisableForLockedAddItem =
        shouldDimForLineup && isLockedAddItemMode;
    final isSelected = activeAbilityBarAgent?.type == agent.type;
    final tileColor = isSelected
        ? Settings.tacticalVioletTheme.primary
        : Settings.tacticalVioletTheme.secondary;
    final displayColor = shouldDimForLineup
        ? Color.lerp(
              tileColor,
              Settings.tacticalVioletTheme.muted,
              isLockedAddItemMode ? 0.5 : 0.35,
            ) ??
            tileColor
        : tileColor;
    final tileOpacity = shouldDimForLineup ? 0.4 : 1.0;
