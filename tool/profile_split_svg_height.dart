...
class _Probe extends StatefulWidget {
  ...
  final SplitSvgHeightRuntime runtime;
    ...
    try {
      ...
      final report = {
        'status': reports.every((row) =>
            ...
            : 'failed',
        'scope':
            'Production Split provider and ten real ViewConeWidget instances. '
                    ...
                    children: [
                      Center(
                        child: SizedBox(
                          ...
                          child: SvgPicture.asset('assets/maps/split_map.svg'),
                        ),
                      ),
  ...
  try {
    ...
    if (fixture['map'] != 'split' || fixture['agentCount'] != 10) {
      throw const FormatException(
          'Expected the frozen ten-observer Split fixture.');
    }
    ...
    final container = ProviderContainer(
      overrides: [mapProvider.overrideWith(_SplitMap.new)],
    );
    final keepAlive =
    ...
    await windowManager.setTitle('Icarus Split SVG sightline profile');
