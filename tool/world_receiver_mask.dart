...
/// Isolated receiver-domain prototype. This is not a source of collision walls.
///
/// A destination must be in the painted map, but the segment leading to it may
/// leave and re-enter that paint. Only the 3D scene determines occlusion along
/// that segment. Parse each side's actual SVG rather than reflecting the other.
